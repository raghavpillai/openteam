  ...
  return (
    ...
    >
      <Collapsible.Trigger className="flex w-full items-center gap-2 px-3 py-2 text-left outline-none hover:bg-accent/60">
        ...
        />
        <span className="rounded-md bg-black/5 px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-wide">
          {kind}
        </span>
      ...
      <Collapsible.Content>
        <pre className="max-h-64 overflow-auto border-t border-black/7 bg-black/[0.025] p-3 font-mono text-[11px] leading-5 whitespace-pre-wrap">
