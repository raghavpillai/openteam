...
- **The apps** connect to your server. Use the desktop app to chat with bots, watch their screens, and manage settings. The iPhone app is in beta on TestFlight. Closing an app doesn't stop work on the server.
