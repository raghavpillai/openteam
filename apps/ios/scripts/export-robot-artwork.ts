...
if(process.argv.includes('--check')) {if(readFileSync(path,'utf8')!==contents)throw new Error('RobotArtwork.json is stale; run bun apps/ios/scripts/export-robot-artwork.ts');}
