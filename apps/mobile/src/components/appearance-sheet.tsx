...
const styles = StyleSheet.create({
  ...
  sectionLabel: { marginTop: 11, fontSize: 13, lineHeight: 18 },
  modeGrid: { marginTop: 5, flexDirection: "row", gap: 8 },
  accentLabel: { marginTop: 22, fontSize: 13, lineHeight: 18 },
  accentGrid: { marginTop: 7, flexDirection: "row", gap: 8 },
  ...
  optionLabel: { marginTop: 6, fontSize: 14, lineHeight: 19 },
