...
- `25-grok-new-bot-onboarding-research.md` preserves the supplied onboarding transcript verbatim and separates observations from inferences.
...
- onboarding and transcript-filesystem evidence: `/Users/raghav/.codex/attachments/1ceaf0e2-91a8-4ba3-9f56-c723df9ff87f/codex-clipboard-a5d3c68a-3aa1-4046-8b75-5dd1b1491a95.png` plus the inline images described in `25-grok-new-bot-onboarding-research.md`;
