...
command = ['xcrun', '--sdk', 'iphonesimulator', 'swiftc', '-sdk', sdk, '-target', 'arm64-apple-ios18.0-simulator', '-parse-as-library', str(root / 'apps/mobile-swift/Sources/Core/LegacySecureStorage.swift'), str(root / 'apps/mobile-swift/scripts/audit-legacy-keychain.swift'), str(stub), '-o', str(app / 'KeychainAudit')]
