...
The components are intentionally checked into OpenBot, following AI Elements' source-owned distribution model. OpenBot removes Next.js and AI SDK message-type coupling while preserving the conversation, prompt, message, and tool interaction patterns.
