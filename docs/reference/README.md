...
The [main documentation](../README.md) covers setup and everyday use. These notes are for operators needing an exact procedure and contributors working on implementation.

## Operator procedures

- [Backup and restore commands](backup-commands.md)
- [Environment and server configuration](server-configuration.md)
- [Self-hosted transcription service](transcription-service.md)
- [Event subscription configuration](automation-event-subscriptions.md)
