...
The results show that **potion-base-2M** reaches 85.21% of the performance of [all-MiniLM-L6-v2](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) with an average score of 47.55 while being orders of magnitude faster.
