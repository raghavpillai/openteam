...
const directory = await mkdtemp(join(tmpdir(), "openteam-widget-parity-"));
...
try {
  ...
  const child = Bun.spawn(
    [
      ...
      resolve(import.meta.dir, "../test/browser/widget-group-parity-runner.cjs"),
    ],
    {
      env: {
        ...process.env,
        ...
        DESKTOP_PARITY_URL: `${server.resolvedUrls!.local[0]}test/browser/widget-group-parity.html`,
      },
      stdout: "pipe",
      stderr: "pipe",
    }
